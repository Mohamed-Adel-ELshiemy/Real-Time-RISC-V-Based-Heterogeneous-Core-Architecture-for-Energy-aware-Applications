...
//approx_adder_0  Approx_Adder_UUT(
// .A($unsigned(adder_in_a)),
// .B($unsigned(adder_in_b)),
// .S(adder_result),
// .C()
//);

//Harris_Top #(32) Harris_Adder_UUT(
//    .adder_Input1(adder_in_a),
//    .adder_Input2(adder_in_b),
//    .adder_Output(adder_result),
//    .adder_Carry_Out()
//    );

//HC_Adder_Top #(32) HC_Adder_UUT(
//    .adder_Input1(adder_in_a),
//    .adder_Input2(adder_in_b),
//    .adder_Output(adder_result),
//    .adder_Carry_Out()
