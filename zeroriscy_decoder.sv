...
`include "D:/Mohamed Adel Elsheimy/zero-riscy-system-verilog-pulpinov1/include/zeroriscy_defines.sv"
...
//      //////////////////////////////////////////////////////////////////////
//      //*****       Core Selection Based on Intput Instruction       *****//
//      //////////////////////////////////////////////////////////////////////
//      OpCODE_CORE_SWITCH: begin
...
//                mult_int_en           = 1'b1;
//                multdiv_signed_mode_o = 2'b00;
//                illegal_insn_o        = RV32M_temp ? 1'b0 : 1'b1;
//            end
//            {6'b00_0001, 3'b001}: begin // mulh
//                alu_operator_o        = ALU_ADD;
//                multdiv_operator_o    = MD_OP_MULH;
...
//      end
  ...
  //////////////////////////////////////////////////////////////////////
//  assign RV32M = RV32M_temp;
//  assign RV32E = RV32E_temp;    
...
//  assign mult_int_en_o     = RV32M_temp ? ((deassert_we) ? 1'b0 : mult_int_en) : 1'b0;
//  assign div_int_en_o      = RV32M_temp ? ((deassert_we) ? 1'b0 : div_int_en ) : 1'b0;
