...
//`include "D:/Mohamed Adel Elsheimy/zero-riscy-system-verilog-pulpinov1/include/param0.v"
//   reg [63:0] mem [0:(9*16)-1];
   reg [63:0] mem [0:(9*16)-1];
initial
begin
$readmemh("D:/Mohamed Adel Elsheimy/zero-riscy-system-verilog-pulpinov1/param0.txt",mem);
end
 //  reg [63:0]    dout;
