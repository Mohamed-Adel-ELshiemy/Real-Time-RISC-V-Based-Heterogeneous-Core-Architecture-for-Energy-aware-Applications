...
//  logic [bus_width-1:0] boot_addr_i;
...
//  logic        debug_we_i;
//  logic [bus_width-1:0] debug_wdata_i;
//  logic [bus_width-1:0] debug_rdata_o;
...
//  logic        debug_resume_i;
  ...
  logic [bus_width-1:0]       pc_if;             // Program counter in IF stage
  logic [bus_width-1:0]       pc_id;             // Program counter in ID stage
  ...
  logic [bus_width-1:0] jump_target_ex;
  logic        branch_in_ex;
  ...
  //////////////////////////////////////////////////////////////////////
  //*****       Core Selection Base The Intput Instruction       *****//
  //////////////////////////////////////////////////////////////////////
//  logic        RV32M;
  
  // ALU Control
  logic [ALU_OP_WIDTH-1:0] alu_operator_ex;
  logic [bus_width-1:0] alu_operand_a_ex;
  logic [bus_width-1:0] alu_operand_b_ex;

    // CHANGE FGPGA 

  logic [bus_width-1:0] alu_adder_result_ex; // Used to forward computed address to LSU   
  logic [bus_width-1:0] regfile_wdata_ex;
  ...
  logic [bus_width-1:0] multdiv_operand_a_ex;
  logic [bus_width-1:0] multdiv_operand_b_ex;

  // MMULT
  logic        mmult_en_ex;
  logic [2:0]  mmult_operator_ex;
  logic [6:0]  mmult_param_ex;
  logic [bus_width-1:0] mmult_operand_addr_ex;
  logic [bus_width-1:0] mmult_operand_data_ex;
  logic        mmult_stall;
  logic [bus_width-1:0] mmult_result;
  ...
  logic [bus_width-1:0] csr_rdata;
  logic [bus_width-1:0] csr_wdata;
  ...
  logic        data_req_ex;
  logic [bus_width-1:0] data_wdata_ex;
  logic        data_load_event_ex;
  logic [bus_width-1:0] regfile_wdata_lsu;
  ...
  logic        m_irq_enable;
  PrivLvl_t    m_prv;
  logic [bus_width-1:0] mtvec;
  logic [bus_width-1:0] mepc;
  ...
  logic [bus_width-1:0] dbg_reg_rdata;

  // Debug GPR Write Access
  logic        dbg_reg_wreq;
  logic [4:0]  dbg_reg_waddr;
  logic [bus_width-1:0] dbg_reg_wdata;

  // Debug CSR Access
  logic        dbg_csr_req;
  logic [11:0] dbg_csr_addr;
  logic        dbg_csr_we;
  logic [bus_width-1:0] dbg_csr_wdata;

  logic [bus_width-1:0] dbg_jump_addr;
  logic        dbg_jump_req;
...
//  instruction_mem instructio_mrmory(
//                                     .a(instr_addr_o),
//					                 .rd(instr_rdata_i)
//					                 );				       
...
//    .data_RF_X5_OR_to_seven_segment_display(data_RF_X5_OR_to_seven_segment_display),
  ...
  assign csr_op       = (dbg_csr_req == 1'b0) ? csr_op_ex
                                              : (dbg_csr_we == 1'b1 ? CSR_OP_WRITE
                                                                    : CSR_OP_NONE );
  assign csr_addr_int = csr_access_ex ? alu_operand_b_ex[bus_width-1:0] : '0;
...
`ifdef TRACE_EXECUTION
  ...
  (
    ...
    .wb_reg_waddr   ( (lsu_stall)? 5'b0:id_stage_i.regfile_waddr_wb ),
